...
pub async fn create_question(
    ...
    match question {
        ...
        Err(err) => {
            error!("An error occured while creating Question: {:?}", err);
...
pub async fn read_questions(
    ...
    match questions {
        ...
        Err(err) => {
            error!("An error occured while reading Questions: {:?}", err);
            Err(HandlerError::default_internal_error())
        }
    }
}
...
pub async fn create_answer(
    ...
    match answer {
        Ok(answer) => Ok(answer),
        Err(err) => {
            error!("An error occured while creating Answer: {:?}", err);
...
pub async fn read_answers(
    ...
    match answers {
        ...
        Err(e) => {
            error!("An error occured while reading Answers: {:?}", e);
            Err(HandlerError::default_internal_error())
        }
    }
}
